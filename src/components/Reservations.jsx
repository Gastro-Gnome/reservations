...
let Reservations = () => {
    return (
        <div className="island-item">
            <div className="reservation-title reservation-header">
                <span className="icon">
                <svg id="24x24_reservation" height="24" viewBox="0 0 24 24" width="24"><path d="M18 21H6a3 3 0 0 1-3-3V6a3 3 0 0 1 3-3 1 1 0 0 1 2 0h8a1 1 0 0 1 2 0 3 3 0 0 1 3 3v12a3 3 0 0 1-3 3zm1-13H5v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1V8zm-6 5h4v4h-4v-4z"></path></svg>
                </span>
                <span>
